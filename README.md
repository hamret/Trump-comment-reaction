...
## 1. 이 주제는 왜?
트럼프 미국 대통령은 **2018년부터 본격적으로 고율의 관세를 부과하는 정책**을 시행하며, 미국 중심의 보호무역주의 기조를 강하게 드러냈습니다. 이러한 관세 정책은 단순한 경제적 조치에 그치지 않고, 미국과 주요 교역국들(중국, 캐나다, 멕시코) 간의 무역 관계를 크게 재편하며, 국제 정치 질서와 글로벌 공급망에 광범위한 영향을 미쳤습니다. 이는 미국 내에서도 찬반이 극명하게 갈리는 뜨거운 논쟁거리로 부상했으며, 정치·경제·언론계 전반에 걸쳐 다양한 반응을 이끌어냈습니다.

이 프로젝트는 트럼프의 관세 정책에 대한 대중의 반응에 호기심이 생겨 시작하였습니다. 특히 관심을 가졌던 부분은, 단순히 정책 그 자체만 아니라, 이를 보도하는 언론사의 성향에 따라 대중이 어떤 반응을 보였는가였습니다. 미국 언론은 성향에 따라 같은 사안을 전혀 다른 방식으로 보도하기 때문에, 동일한 이슈에 대한 대중의 반응 역시 매체에 따라 상이할 수 있습니다. 이에 따라 우리는 언론사의 보도 방식과 시청자 반응 간의 관계를 구체적으로 분석해 보고자 했습니다.

분석 대상 매체는 다음 세 곳으로 선정하였습니다:
...
**CNBC**는 **중립에서 보수 성향 사이에 위치한 경제 전문 채널**로, 정책의 실효성과 시장 반응에 중점을 둔 보도를 합니다. 이 매체는 기업의 관세 회피 전략, 시장 반응, 공급망 대응 등 실질적 경제 작동 방식에 초점을 맞춥니다.

**MSNBC**는 **진보 성향의 언론사**로, **트럼프 정부의 정책에 대해 비판적인 시각**을 유지하며 특히 정치적 책임과 윤리성 측면을 강조합니다. 외교적 긴장, 리더십 문제 등 정치적 효과를 부각시킵니다.

**The Late Show with Stephen Colbert**는 **풍자와 유머를 기반으로 한 토크쇼**로, 직접적인 뉴스 보도보다는 문화적·정서적 관점에서 대중 정서를 대변합니다. 이 프로그램은 코미디를 통해 트럼프 행정부의 정책을 비판하고 조롱하며, 정치 담론을 대중적으로 해석합니다.

이 세 언론사는 각기 다른 시각—경제, 정치, 대중문화—에서 트럼프의 관세 정책을 다루고 있으며, 이를 통해 하나의 정책이 어떤 식으로 입체적으로 조명될 수 있는지를 잘 보여줍니다. 동일한 주제를 다루되, 전달 방식, 포맷, 시청자층이 모두 다른 이들 언론사는, 본 프로젝트의 분석 목적에 매우 적합했습니다. 이는 정치 이슈가 미디어 환경 속에서 어떻게 해석되고, 그 해석이 대중의 인식에 어떤 영향을 미치는가라는 핵심 질문에 대한 통찰을 제공해줍니다.

또한, 유튜브라는 플랫폼을 분석 대상으로 선택한 이유도 여기에 있습니다. 유튜브는 단순히 영상을 소비하는 공간이 아니라, 댓글을 통해 대중의 실시간 반응, 감정, 의견을 확인할 수 있는 사회적 여론의 반영 장치입니다. 이는 기존 설문조사나 인터뷰 방식보다 훨씬 생생하고 풍부한 데이터를 제공하며, 감성 분석 및 언어 처리 기술을 통해 다양한 인사이트를 이끌어낼 수 있습니다.

결과적으로, 본 프로젝트는 서로 다른 성향의 언론이 동일한 정책을 어떻게 보도하고, 그 보도에 대해 대중이 어떤 정서적 반응을 보였는지를 BERT 기반 감성 분석을 통해 구체적으로 살펴봄으로써, 현대 정치가 언론과 플랫폼, 대중 간 상호작용 속에서 어떻게 형성되는지를 엿보려는 시도를 하였습니다.
...
- 세 언론사(CNBC, MSNBC, The Late Show with Stephen Colbert)에서 각각 약 600여 건씩 균형 있게 샘플링하여,
  언론사 간 비교 분석이 가능하도록 구성하였습니다.

- 하루에 약 200개씩, 총 10일간 수작업으로 라벨링을 진행하였으며,
  분석 기준은 다음과 같이 정의하였습니다:
...
- 영어 댓글이다 보니 번역 과정에서 ChatGPT를 활용하여 번역과 관련한 내용을 받아서 본 후에 스스로의 판단으로 라벨링을 진행하였습니다.

- 라벨링 과정에서 문맥이 모호하거나 풍자, 비유 등이 포함된 댓글에 대해서는
  번역을 받은후 관련 내용과 비교하여 라벨링을 진행하였습니다.

- 사람의 해석과 AI 언어 모델의 언어 이해 능력을 함께 활용함으로써
  감정 분류 기준의 일관성과 해석의 신뢰도와 라벨링 속도를 높일 수 있었습니다.
