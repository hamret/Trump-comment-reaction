...
## 1. 이 주제는 왜?
트럼프 전 미국 대통령은 2018년부터 본격적으로 고율의 관세를 부과하는 정책을 시행하며, 미국 중심의 보호무역주의 기조를 강하게 드러냈습니다. 이러한 관세 정책은 단순한 경제적 조치에 그치지 않고, 미국과 주요 교역국들(특히 중국, 캐나다, 멕시코) 간의 무역 관계를 크게 재편하며, 국제 정치 질서와 글로벌 공급망에 광범위한 영향을 미쳤습니다. 이는 미국 내에서도 찬반이 극명하게 갈리는 뜨거운 논쟁거리로 부상했으며, 정치·경제·언론계 전반에 걸쳐 다양한 반응을 이끌어냈습니다.

이 프로젝트는 바로 이 트럼프의 관세 정책에 대한 대중의 반응을 정량적으로 분석해보고자 시작되었습니다. 특히 관심을 가졌던 부분은, 단순히 정책 그 자체가 아닌, 이를 보도하는 언론사의 성향에 따라 대중이 어떤 반응을 보였는가였습니다. 미국 언론은 성향에 따라 같은 사안을 전혀 다른 방식으로 보도하기 때문에, 동일한 이슈에 대한 대중의 반응 역시 매체에 따라 상이할 수 있습니다. 이에 따라 우리는 언론사의 보도 방식과 시청자 반응 간의 관계를 구체적으로 분석해 보고자 했습니다.
...
**MSNBC**는 **진보 성향의 언론사**로, 트럼프 행정부의 정책에 대해 비판적인 시각을 유지하며 특히 정치적 책임과 윤리성 측면을 강조합니다. 외교적 긴장, 리더십 문제 등 정치적 효과를 부각시킵니다.
